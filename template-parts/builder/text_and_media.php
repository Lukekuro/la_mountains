<?php
/**
 * Text & media builder part
 *
 * @package mountainser
 */

$text_order  = get_sub_field( 'order' ); // possible values: text_first, text_last.
...
<section class="m-text-media c-block<?php echo esc_attr( $extra_class ); ?>" style="background-color: <?php echo esc_attr( $bg_color ); ?>">
	<div class="container">
		<div class="row <?php echo 'text_last' === $text_order ? 'flex-lg-row-reverse' : ''; ?>">
			<div class="col-lg-6">
				<?php if ( $text ) : ?>
